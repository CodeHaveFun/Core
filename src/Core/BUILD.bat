...
@echo off
cls
title Core Project - Corex Compiler Builder
echo.

:: File DLL Runtime for ICU (UNICODE)
...
echo.
echo Checking file unicode dll file runtime - International Components for Unicode (ICU)...
if exist %icudt79% (
